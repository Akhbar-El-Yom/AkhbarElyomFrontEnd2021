(function($) {
    ...
    if ($('.main-slider-six .image-carousel').length && $('.main-slider-six .thumbs-carousel').length) {

        var $sync1 = $(".main-slider-six .image-carousel"),
            $sync2 = $(".main-slider-six .thumbs-carousel"),
            flag = false,
            duration = 500;
